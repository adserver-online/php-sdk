...
class PaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const IDSTATUS_1000 = 1000;
    public const IDSTATUS_1010 = 1010;
    public const IDSTATUS_1020 = 1020;
    ...
    */
     ...
     * Sets idstatus
     *
     * @param int|null $idstatus Statuses:  * 1000 - Pending  * 1010 - Completed  * 1020 - Cancelled
     *
     * @return self
     */
