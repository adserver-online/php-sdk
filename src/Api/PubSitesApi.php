...
class PubSitesApi
{
     ...
     */
    public function pubCreateSite($site_request)
    {
        list($response) = $this->pubCreateSiteWithHttpInfo($site_request);
        return $response;
    }
     ...
     */
    public function pubCreateSiteWithHttpInfo($site_request)
    {
        $request = $this->pubCreateSiteRequest($site_request);
     ...
     */
    public function pubCreateSiteAsync($site_request)
    {
        return $this->pubCreateSiteAsyncWithHttpInfo($site_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pubCreateSiteAsyncWithHttpInfo($site_request)
    {
        $returnType = '\Adserver\Model\Site';
        $request = $this->pubCreateSiteRequest($site_request);
     ...
     */
    protected function pubCreateSiteRequest($site_request)
    {
        // verify the required parameter 'site_request' is set
        if ($site_request === null || (is_array($site_request) && count($site_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_request when calling pubCreateSite'
            );
        }
     ...
     * @return \Adserver\Model\Site|\Adserver\Model\FormErrorResponse
     */
    public function pubUpdateSite($id, $site_request)
    {
        list($response) = $this->pubUpdateSiteWithHttpInfo($id, $site_request);
        return $response;
    }
     ...
     * @return array of \Adserver\Model\Site|\Adserver\Model\FormErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pubUpdateSiteWithHttpInfo($id, $site_request)
    {
        $request = $this->pubUpdateSiteRequest($id, $site_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pubUpdateSiteAsync($id, $site_request)
    {
        return $this->pubUpdateSiteAsyncWithHttpInfo($id, $site_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pubUpdateSiteAsyncWithHttpInfo($id, $site_request)
    {
        $returnType = '\Adserver\Model\Site';
        $request = $this->pubUpdateSiteRequest($id, $site_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function pubUpdateSiteRequest($id, $site_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($site_request === null || (is_array($site_request) && count($site_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_request when calling pubUpdateSite'
            );
        }
