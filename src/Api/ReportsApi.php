...
class ReportsApi
{
    ...
    protected function getEventsRequest($date_begin, $date_end, $report, $group, $timezone = null, $idadvertiser = null, $idcampaign = null, $idgroup = null, $idad = null, $idpublisher = null, $idsite = null, $idzone = null)
    {
        ...
        if ($idadvertiser !== null) {
            $queryParams['idadvertiser'] = ObjectSerializer::toQueryValue($idadvertiser);
        }
        // query params
        if ($idcampaign !== null) {
        ...
        // query params
        if ($idgroup !== null) {
            $queryParams['idgroup'] = ObjectSerializer::toQueryValue($idgroup);
        }
        // query params
        if ($idad !== null) {
            $queryParams['idad'] = ObjectSerializer::toQueryValue($idad);
        }
        // query params
        if ($idpublisher !== null) {
            $queryParams['idpublisher'] = ObjectSerializer::toQueryValue($idpublisher);
        }
        // query params
        if ($idsite !== null) {
