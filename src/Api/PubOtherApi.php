...
class PubOtherApi
{
     ...
     *
     * Return publisher's data dictionaries
     *
     *
     ...
     * @return object
     */
    public function pubGetDictionaries()
    {
        list($response) = $this->pubGetDictionariesWithHttpInfo();
        return $response;
    }
     ...
     */
    public function pubGetDictionariesWithHttpInfo()
    {
        $request = $this->pubGetDictionariesRequest();
     ...
     */
    public function pubGetDictionariesAsync()
    {
        return $this->pubGetDictionariesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pubGetDictionariesAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->pubGetDictionariesRequest();
     ...
     */
    protected function pubGetDictionariesRequest()
    {
